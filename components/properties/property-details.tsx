  ...
  return (
    <section className="space-y-6 sm:space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-[#6b7280] sm:text-base break-words">{property.location} • {property.propertyType}</p>
        <p className="text-2xl font-semibold text-[#111111] sm:text-3xl">{formatPrice(property.price)}</p>
        <p className="text-sm leading-7 text-[#6b7280] sm:text-base break-words">{property.summary}</p>
        <div>
