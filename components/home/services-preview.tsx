      ...
      <SectionContainer className="space-y-10">
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service, index) => (
            <article
              key={service.slug}
              className="group flex h-full flex-col rounded-2xl border border-[#e2e6ec] bg-white p-6 sm:p-7 shadow-[0_6px_20px_rgba(17,17,17,0.05)] transition hover:border-[#d4d9e2] hover:shadow-[0_12px_26px_rgba(17,17,17,0.08)]"
            >
